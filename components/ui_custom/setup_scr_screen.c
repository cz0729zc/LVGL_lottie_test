...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_animimg_1, 38, 94);
    lv_obj_set_size(ui->screen_animimg_1, 51, 56);
    lv_animimg_set_src(ui->screen_animimg_1, (const void **) screen_animimg_1_imgs, 6);
    lv_animimg_set_duration(ui->screen_animimg_1, 120*6);
