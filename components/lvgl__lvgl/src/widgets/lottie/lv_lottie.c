...
static void lottie_update(lv_lottie_t * lottie, int32_t v)
{
    printf("lottie_update called, frame=%ld\n", v);
    ...
    Tvg_Result res = tvg_canvas_draw(lottie->tvg_canvas);
    printf("tvg_canvas_draw result: %d\n", res);
