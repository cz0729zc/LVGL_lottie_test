...
//  #define EXAMPLE_LCD_GPIO_MOSI       (GPIO_NUM_40)
//  #define EXAMPLE_LCD_GPIO_RST        (GPIO_NUM_41)
//  #define EXAMPLE_LCD_GPIO_DC         (GPIO_NUM_42)
//  #define EXAMPLE_LCD_GPIO_CS         (GPIO_NUM_38)
//  #define EXAMPLE_LCD_GPIO_BL         (GPIO_NUM_2)
#define EXAMPLE_LCD_GPIO_SCLK       (GPIO_NUM_10)   // SPI SCLK
#define EXAMPLE_LCD_GPIO_MOSI       (GPIO_NUM_11)   // SPI MOSI
#define EXAMPLE_LCD_GPIO_RST        (GPIO_NUM_12)   // LCD RESET
#define EXAMPLE_LCD_GPIO_DC         (GPIO_NUM_13)   // LCD DC
#define EXAMPLE_LCD_GPIO_CS         (GPIO_NUM_14)   // LCD CS
#define EXAMPLE_LCD_GPIO_BL         (GPIO_NUM_2)    // LCD 背光（原样保留）
...
//  LV_IMG_DECLARE(esp_logo)
 ...
 uint8_t *g_lottie_buf = NULL;
 size_t g_lottie_buf_size = 0;
...
//      lv_obj_align(img_logo, LV_ALIGN_TOP_MID, 0, 20);
    ...
    // for (int i = 0; i < 16; i++) {
    //     uint32_t pixel = ((uint32_t*)lottie_buf)[i];
    //     printf("px[%02d] = 0x%08lX\n", i, pixel);
    // }
